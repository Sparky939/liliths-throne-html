...
(function () {
    ...
    LT.BODY_SIZE_LIST = list(LT.BODY_SIZE.ZERO_SKINNY, LT.BODY_SIZE.ONE_SLENDER, LT.BODY_SIZE.TWO_AVERAGE, LT.BODY_SIZE.THREE_LARGE, LT.BODY_SIZE.FOUR_HUGE);
    LT.MUSCLE = {
    ...
    LT.MUSCLE_LIST = list(LT.MUSCLE.ZERO_SOFT, LT.MUSCLE.ONE_LIGHTLY, LT.MUSCLE.TWO_TONED, LT.MUSCLE.THREE_MUSCULAR, LT.MUSCLE.FOUR_RIPPED);
    LT.LIP = {
    ...
    LT.HAIR_LENGTH_LIST = list(LT.HAIR_LENGTH.ZERO_BALD, LT.HAIR_LENGTH.ONE_VERY_SHORT, LT.HAIR_LENGTH.TWO_SHORT, LT.HAIR_LENGTH.THREE_SHOULDER, LT.HAIR_LENGTH.FOUR_LONG, LT.HAIR_LENGTH.FIVE_VERY_LONG, LT.HAIR_LENGTH.SIX_INCREDIBLY);
    LT.HAIR_STYLE = [
    ...
    LT.CUP_LIST = list(LT.CUP.FLAT, LT.CUP.AA, LT.CUP.A, LT.CUP.B, LT.CUP.C, LT.CUP.D, LT.CUP.DD, LT.CUP.E, LT.CUP.F, LT.CUP.FF, LT.CUP.G, LT.CUP.GG, LT.CUP.H);
    LT.BREAST_SHAPE = [
        item("ROUND", "round"),
        item("POINTY", "pointy"),
        item("PERKY", "perky"),
    ...
    LT.hairLengthIndex = function (id) {
        for (var i = 0; i < LT.HAIR_LENGTH_LIST.length; i++) {
            if (LT.HAIR_LENGTH_LIST[i].id === id)
                return i;
        }
        return 0;
    };
    LT.bodyShapeOf = function (size, muscle) {
        ...
        if (mi < 0)
            mi = 2;
        if (mi >= 3 && si <= 1)
            return { name: "athletic", colour: "#57be7e" };
        if (mi >= 3)
            return { name: "muscular", colour: "#c06060" };
        if (si >= 4)
            return { name: "huge", colour: "#4f88ab" };
        if (si >= 3)
            return { name: "large", colour: "#6fa4c4" };
        if (si === 0)
            return { name: "skinny", colour: "#c9dde8" };
        if (si === 1)
            return { name: "slender", colour: "#9ec9dc" };
...
//# sourceMappingURL=bodyEnums.js.map