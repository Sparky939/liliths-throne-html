...
(function () {
    ...
    function labDoorResponses() {
        ...
        if (lilayaInLab()) {
            ...
            list.push(new LT.Response("Enter", "The door to Lilaya's laboratory is firmly shut, and, considering the hour, she's probably sleeping upstairs.", null).disable("The door is shut. Come back during the day."));
        }
        return list;
    }
    LT.defineNode({
    ...
    LT.defineNode({
        ...
        applyPreParsingEffects: function () {
            ...
            if (typeof LT.syncSlaveNpcs === "function")
                LT.syncSlaveNpcs();
            if (typeof LT.maybeWorkplaceSex === "function")
                LT.maybeWorkplaceSex();
        },
        getContent: function () {
        ...
        getResponses: function () {
            ...
            if (typeof LT.slavePresenceResponses === "function")
                LT.slavePresenceResponses(list);
            ...
            if (quest === "MAIN_1_A_LILAYAS_TESTS") {
                ...
                if (LT.game.flags && LT.game.flags.hadSexWithLilaya) {
                    list.push(new LT.Response("\"Tests\"", "Let Lilaya know that you're here to let her run more of her \"tests\" on you.", "lab.moreSex"));
                }
                else {
                    list.push(new LT.Response("Tests", "Tell Lilaya that you want her to run more of her 'tests' on you.", "lab.testingRepeat"));
                }
            }
            if (LT.game.flags && LT.game.flags.enchantmentQuest === "SIDE_ENCHANTMENTS_LILAYA_HELP") {
                list.push(new LT.Response("Essences", "Ask Lilaya about the strange energy you absorbed.", "lab.essences"));
            }
            else if (LT.game.flags && (LT.game.flags.enchantmentQuest === "complete" || LT.game.flags.canEnchant)) {
                list.push(new LT.Response("Extract essences", LT.game.flags.essenceExtractionKnown
                    ? "Ask Lilaya if you can use her equipment to extract some essences."
                    : "Ask Lilaya if there's any way to extract essences you've absorbed.", "lab.extract"));
            }
            if (typeof LT.isVisiblyPregnant === "function" && LT.isVisiblyPregnant(LT.game.player)) {
                if (!(LT.questReached && LT.questReached("MAIN_1_B_DEMON_HOME")) && LT.game.flags.quest === "MAIN_1_A_LILAYAS_TESTS") {
                    list.push(new LT.Response("Pregnancy", "You'll need to complete Lilaya's initial tests before she'll agree to help you deal with your pregnancy.", null).disable("You'll need to complete Lilaya's initial tests before she'll agree to help you deal with your pregnancy."));
                }
                else if (LT.game.flags.pregnancyQuest === "SIDE_PREGNANCY_CONSULT_LILAYA") {
                    list.push(new LT.Response("Pregnancy", "Speak to Lilaya about your pregnancy.", "lab.pregnancy", function () {
            ...
            if (LT.game.flags && LT.game.flags.slaveryQuest === "SIDE_SLAVER_NEED_RECOMMENDATION") {
                if (!(LT.questReached && LT.questReached("MAIN_1_B_DEMON_HOME"))) {
                    list.push(new LT.Response("Slaver", "You'll need to complete Lilaya's initial tests before you can ask her for a letter of recommendation.", null).disable("You'll need to complete Lilaya's initial tests before you can ask her for a letter of recommendation."));
                }
                else {
                    list.push(new LT.Response("Slaver", "Ask Lilaya for a letter of recommendation in order to obtain a slaver license.", "lab.slaver"));
                }
            }
            return list;
        },
    ...
    LT.defineNode({
        ...
        getResponses: function () {
            return [
                null,
                new LT.Response("'Tests'", "Accept Lilaya's offer of more 'tests'. You're not sure what her intentions really are, but you're confident that you'll be able to stop her if she tries any funny business.", "lab.hornyLilaya"),
                new LT.Response("Decline", "Tell Lilaya that you're not up for this sort of thing.", "lab.inside", function () {
    ...
    LT.defineNode({
        ...
        getResponses: function () {
            return [
                ...
                new LT.Response("Stop this", "Stand up and tell Lilaya that this is going too far. While she'll undoubtedly be upset at this sudden end to her advances, you're sure that she'd try to hit on you again if you changed your mind in the future.", "lab.inside", function () {
    ...
    LT.defineNode({
        ...
        getResponses: function () {
            return [
                ...
                new LT.Response("Stop this", "Stand up and tell Lilaya that this has gone too far. While she'll undoubtedly be upset at this sudden end, you're sure that she'd try to hit on you again if you changed your mind in the future.", "lab.inside", function () {
    ...
    LT.defineNode({
        ...
        getResponses: function () {
            return [
                ...
                new LT.Response("Stop", "Tell Lilaya that you need to get going. While she'll definitely be disappointed that you're stopping so soon, you can always come back later if you should change your mind.", "lab.inside", function () {
    ...
    LT.defineNode({
        ...
        getContent: function () {
            var n = LT.game.npcs && LT.game.npcs.lilaya;
            if (n && !(n.orgasmedThisSex > 0))
                return xml("LAB_END_SEX_NO_ORGASM");
    ...
    LT.defineNode({
        ...
        getResponses: function () {
            return [
                null,
                new LT.Response("Accommodation", "Agree with Lilaya's observation that you'll need somewhere to keep your slaves.", "lab.slaverAccommodation", function () {
    ...
    LT.defineNode({
        ...
        getResponses: function () {
            return [
                null,
                new LT.Response("Continue", "Now that you've got Lilaya's letter of recommendation, you should head back to Slaver Alley and talk to Finch.", "lab.inside"),
            ];
        },
    });
    LT.defineNode({
        ...
        getResponses: function () {
            function extract(amount) {
                return function () {
                    ...
                    var i;
                    for (i = 0; i < n; i++)
                        LT.addItem(LT.game.player, "innoxia_items_essence_arcane");
            ...
            if (have < 5)
                five.disable("You don't have enough arcane essences!");
            if (have < 25)
                twenty.disable("You don't have enough arcane essences!");
            return [
