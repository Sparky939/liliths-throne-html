...
(function () {
    ...
    var RIGHT = [
        { id: "zoom", icon: "zoomOut.svg", tip: "Zoom map", action: function () { if (typeof cycleGridZoom === "function")
                cycleGridZoom(); } },
    ...
    LT.initChromeButtons = function () {
        ...
        for (var i = 0; i < LEFT.length; i++)
            left.appendChild(makeBtn(LEFT[i]));
        for (var j = 0; j < RIGHT.length; j++)
            right.appendChild(makeBtn(RIGHT[j]));
    };
})();
//# sourceMappingURL=chromeButtons.js.map