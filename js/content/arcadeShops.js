...
(function () {
        ...
        for (i = 0; i < ids.length; i++) {
            (function (id) {
                ...
                if (LT.getMoney() < price) {
                    ...
                    list.push(new LT.Response(title, "Buy " + item.name + " for " + price + " flames.", leaveNode, function () {
    ...
    LT.defineNode({
        ...
        applyPreParsingEffects: function () {
            if (typeof LT.ensureNyan === "function")
                LT.ensureNyan();
        },
        getContent: function () {
    ...
    LT.defineNode({
        ...
        getContent: function () {
            ...
            if (f.nyanGirlfriend)
                return nyanXml("SHOP_CLOTHING_REPEAT_GIRLFRIEND");
        ...
        getResponses: function () {
            ...
            if (f.nyanQuestComplete) {
                ...
                list.push(new LT.Response("Enchanted clothing", "Ask Nyan if she stocks enchanted clothing. This will start Nyan's romance quest!", "nyan.enchanted-ask", function () {
                ...
                list.push(new LT.Response("Report back", "Tell Nyan that you've dealt with the suppliers.", "nyan.report", function () {
    ...
    LT.defineNode({
        ...
        chrome: { left: true, right: true },
        applyPreParsingEffects: function () {
            if (typeof LT.ensureKate === "function")
                LT.ensureKate();
        },
        getContent: function () {
    ...
    function kateResponses() {
        ...
        function service(title, tip, node, apply) {
            if (LT.getMoney() < cost) {
                ...
                list.push(new LT.Response(title + " (" + cost + ")", tip, node, function () {
    ...
    LT.defineNode({
        ...
        chrome: { left: true, right: true },
        applyPreParsingEffects: function () {
            if (typeof LT.ensureAshley === "function")
                LT.ensureAshley();
        },
        getContent: function () {
...
//# sourceMappingURL=arcadeShops.js.map