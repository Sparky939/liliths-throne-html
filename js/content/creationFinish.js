...
(function () {
    ...
    function wardrobeHtml() {
        ...
        if (!pile)
            pile = '<p class="muted">Nothing left in the pile.</p>';
        var ready = LT.creationClothedEnough(p);
        return ('<div class="wardrobe-banner" style="text-align:center;"><i>Choose what you decided to wear to the museum.</i><br/>' +
    ...
    function backgroundHtml() {
        ...
        return ("<p>Satisfied with your appearance, you turn away from the mirror and begin to walk towards the main stage. With each step you take, you inexplicably find yourself getting more and more turned on, and by the time you've barely covered half the distance to the bustling crowd of visitors, " +
            aroused +
    ...
    function jobsHtml() {
        ...
        var html = '<div class="container-full-width"><h6 style="text-align:center">Job Selection</h6><p style="text-align:center">Click on the job that you\'d like, and then choose Continue.</p></div>';
    ...
    function sexHtml() {
        ...
        var flush = "<p>As the two of you continue to talk, first about work, and then about more general subjects, you find yourself getting more and more turned on. What's more, you begin to notice that " +
            npcName() +
    ...
    function recalcCorruption(p) {
        ...
        c += p.sex.anal * 2;
        c += p.sex.oral;
        if (p.hasPenis() && !p.sex.penisVirgin)
            c += 5;
        if (p.hasVagina() && !p.sex.vaginaVirgin)
            c += 5;
    ...
    function finalHtml() {
        ...
        return ('<div class="container-full-width" style="text-align:center;"><i>Once you\'re happy with your appearance, press the Start Game button to begin!<br/>' +
            '<span style="color:' +
    ...
    function clothesSummary(p) {
        ...
        for (var i = 0; i < slots.length; i++) {
            ...
            if (it)
                parts.push(it.colourName + " " + it.name);
        }
        if (!parts.length)
            return "";
    ...
    LT.defineNode({
        ...
        getResponses: function () {
            ...
            var cont = new LT.Response("Continue", "Satisfied with your appearance, you walk towards the stage.", "creation.background").withTime(150);
            if (!ready)
                cont.disable("You need footwear, and clothing that conceals your genitals and chest.");
    ...
    LT.defineNode({
        ...
        getResponses: function () {
            ...
            var cont = new LT.Response("Continue", "Tell " + npcName() + " what it is you do for a living.", "creation.sex").withTime(150);
            if (!has)
                cont.disable("You need to select a job before continuing!");
    ...
    LT.defineNode({
        ...
        getResponses: function () {
            return [
                ...
                new LT.Response("Continue", "Once you're happy with your sexual experience, proceed to the final part of the character creation.", "creation.confirm").withTime(150),
            ];
        },
    });
    LT.defineNode({
        ...
        getResponses: function () {
            return [
                ...
                new LT.Response("Skip prologue", "Start the game and skip the prologue. Not recommended for a first play.", "place.LILAYA_HOME_ROOM_PLAYER", function () {
                    LT.game.started = true;
                    if (typeof LT.startArrivalStorm === "function")
                    ...
                    if (typeof LT.incrementExperience === "function")
                        LT.incrementExperience(5);
                    if (typeof LT.refreshVitals === "function")
                        LT.refreshVitals(LT.game.player, true);
...
//# sourceMappingURL=creationFinish.js.map