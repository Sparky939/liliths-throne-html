...
(function () {
    ...
    var DISCLAIMER = '<h6 style="text-align:center;color:' +
    ...
    LT.defineNode({
        ...
        getResponses: function () {
            return [
                null,
                new LT.Response("Agree", "You agree that you are the legal age to view pornographic material, and consent to being exposed to graphic content.", "boot.patch-notes"),
            ];
        },
    });
    LT.defineNode({
        ...
        chrome: { left: false, right: false },
        getContent: function () {
            return ('<div class="inner-text-content">' +
    ...
    LT.defineNode({
        ...
        getResponses: function () {
            ...
            if (LT.game.started && LT.game.player) {
                list.push(new LT.Response("Resume", "Return to the game.", LT.game.returnNode || "place.generic", function () {
            ...
            list.push(new LT.Response("New Game", "Start a new game.", "creation.appearance", function () {
                LT.startNewGame();
            }), new LT.Response("Save/Load", "Open the save/load window.", null, function () {
                LT.openSaveLoad();
            }), new LT.Response("Options", "Open the options menu.", "boot.options"), new LT.Response("Mod menu", "Open the work-in-progress mod configuration menu.", "boot.mod-menu"), new LT.Response("Disclaimer", "View the game's disclaimer.", "boot.disclaimer"));
            return list;
        },
    });
    LT.defineNode({
    ...
    LT.defineNode({
        ...
        chrome: { left: false, right: false },
        getContent: function () {
            return ("<p><b>Work in progress.</b> This rebuild does not load gameplay mods yet.</p>" +
...
//# sourceMappingURL=bootFlow.js.map