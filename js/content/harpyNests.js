    ...
    LT.defineNode({
        ...
        getContent: function () {
            if (!(LT.isWorkTime && LT.isWorkTime()))
                return nestXml("HELENAS_NEST_EXTERIOR_SLEEPING");
            return nestXml("HELENAS_NEST_EXTERIOR");
        },
        getResponses: function () {
            var list = LT.travelResponses ? LT.travelResponses() : [null];
            if (!(LT.isWorkTime && LT.isWorkTime())) {
                list.push(new LT.Response("Meet with Helena", "Both Helena and her flock are sleeping in the buildings below her nest.", null).disable("You'll have to come back during the day if you want to speak with her."));
            }
...
//# sourceMappingURL=harpyNests.js.map