...
(function () {
    ...
    function leaveToStreet() {
        if (typeof LT.travelToPlace === "function")
            LT.travelToPlace("DOMINION", "DOMINION_ENFORCER_HQ");
    }
    LT.defineNode({
    ...
    function defineHqPlace(id, title, tag, extras) {
        ...
        LT.defineNode({
            ...
            applyPreParsingEffects: extras.applyPreParsingEffects || function () {
                if (typeof LT.ensureCandi === "function")
                    LT.ensureCandi();
    ...
    defineHqPlace("place.ENFORCER_HQ_CORRIDOR", "Corridor", "CORRIDOR", {
        getContent: function () {
            ...
            if (loc && loc.x === 4 && loc.y === 4)
                html += generic("CORRIDOR_BRAX_WARNING");
            return html;
        },
    });
    ...
    defineHqPlace("place.ENFORCER_HQ_GUARDED_DOOR", "Guarded door", "GUARDED_DOOR", {
        getResponses: function () {
            var list = [null];
            if (!hasPass()) {
                list.push(new LT.Response("Step back", "You don't really see much option other than to do as the Enforcer says.", null, function () {
                    LT.game.textStart = generic("GUARDED_DOOR_STEP_BACK");
                    if (typeof LT.travelToPlace === "function")
                        LT.travelToPlace("ENFORCER_HQ", "ENFORCER_HQ_WAITING_AREA");
                }));
            }
            return list;
        },
    ...
    LT.defineNode({
        ...
        getResponses: function () {
            return [
                null,
                new LT.Response("Step back", "Now that you've got what you were after, you can step away from Candi's desk.", "place.ENFORCER_HQ_WAITING_AREA"),
            ];
        },
    });
    LT.defineNode({
        ...
        applyPreParsingEffects: function () {
            ...
            if (b)
                b.location = { world: "ENFORCER_HQ", place: "ENFORCER_HQ_BRAXS_OFFICE" };
        },
        getContent: function () {
        ...
        getResponses: function () {
            return [
                ...
                new LT.Response("Lie", "You notice that all of the models in the posters are wolf-girls. Perhaps you could pretend that Arthur is a patron of an exclusive wolf-girl themed brothel that you so happen to own...", "enforcer.braxLie"),
                new LT.Response("Wolf-tease", "Use your feminine wolf-like body to tease [brax.name] into giving you information about Arthur.", null).disable("You need to be a feminine wolf-morph, and that transformation is not in this build."),
            ];
        },
    });
    LT.defineNode({
    ...
    LT.defineNode({
        ...
        getResponses: function () {
            return [
                null,
                new LT.Response("Keep on bluffing", "Imply that 'The She-wolf's Den' is a brothel you own. If he'll give you information about Arthur, you'll give him VIP status.", "enforcer.braxBluff"),
                new LT.Response("Drop the act", "Tell [brax.name] that he's an idiot and you're here to find out what he's done with Arthur.", "enforcer.braxIdiot"),
            ];
        },
    });
    LT.defineNode({
    ...
    LT.defineNode({
        ...
        getResponses: function () {
            return [
                null,
                new LT.Response("Let him go", "Tell [brax.name] to have fun. From your directions, it'll take at least a couple of hours before he figures out he's been fooled.", "enforcer.braxSuccess", function () {
    ...
    function braxFight(tip) {
        ...
        return LT.ResponseCombat("Fight", LT.parse(tip), {
            ...
            onVictory: function () {
                if (LT.game.flags.quest === "MAIN_1_C_WOLFS_DEN")
                    return LT.advanceMainQuest("MAIN_1_D_SLAVERY");
                return "";
            },
            onDefeat: function () {
    ...
    LT.defineNode({
        ...
        getResponses: function () {
            return [
                ...
                LT.ResponseSex("Dominate Brax", "Brax's broken, horny form is too much for you to resist, and you can't help but smile down deviously at the wolf-boy as you prepare to make him your bitch.", {
                ...
                LT.ResponseSex("Submit to Brax", "Although you've defeated him, your submissive nature is causing you to consider letting Brax dominantly fuck you...", {
                    partner: LT.game.npcs.brax,
                    playerDom: false,
                    consensual: true,
    ...
    LT.defineNode({
        ...
        getResponses: function () {
            return [
                ...
                new LT.Response("Swallow", "Do as Brax says and swallow the strange liquid.", null).disable("Forced transformation is not in this build. Spit, then leave."),
            ];
        },
    });
    LT.defineNode({
    ...
    LT.defineNode({
        ...
        getResponses: function () {
            if (LT.questReached && LT.questReached("MAIN_1_D_SLAVERY"))
                return braxUniforms();
            return [
                null,
...
//# sourceMappingURL=enforcerHQ.js.map