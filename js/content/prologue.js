...
(function () {
    ...
    function node(id, title, seconds, getContent, responses, continues) {
        LT.defineNode({
            id: id,
            ui: "dialogue",
            title: title,
    ...
    node("prologue.empty-room", "In the Museum", 90, function () {
        ...
        return [
            null,
            wrapSex(LT.ResponseSex("Dominant sex", domTip, {
                partner: partner,
                playerDom: true,
                consensual: true,
            ...
            wrapSex(LT.ResponseSex("Submissive sex", subTip, {
                partner: partner,
                playerDom: false,
                consensual: true,
        ...
        return [
            ...
            new LT.Response("Blinded", "The pink flash was so bright that you're left temporarily blinded!", "prologue.new-world-5", function () {
                ...
                for (var i = 0; i < slots.length; i++)
                    LT.unequipToWardrobe(p, slots[i]);
            }),
        ];
    }, true);
