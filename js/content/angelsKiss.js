...
(function () {
    ...
    LT.defineNode({
        ...
        getResponses: function () {
            ...
            list.push(new LT.Response("Office", "Follow the corridor to Angel's office and ask about a prostitution license.", null, function () {
                if (typeof LT.enterWorld === "function")
                    LT.enterWorld("ANGELS_KISS_GROUND_FLOOR", "ANGELS_KISS_OFFICE");
                else
    ...
    function officeTag() {
        if (hasLicense())
            return "OFFICE_REPEAT_WITH_LICENSE";
        if (metAngel())
            return "OFFICE_REPEAT";
        return "OFFICE";
    }
    function officeResponses() {
        ...
        if (LT.getMoney() >= cost) {
            list.push(new LT.Response("License (" + cost + ")", "Agree to Angel's deal and purchase a prostitution license.", "angel.license", function () {
            ...
            list.push(new LT.Response("License (" + cost + ")", "You don't have enough money to buy a prostitution license.", null).disable("A prostitution license costs " + cost + " flames."));
        }
        return list;
    }
    LT.defineNode({
    ...
    LT.defineNode({
        ...
        chrome: { left: true, right: true },
        applyPreParsingEffects: function () {
            if (typeof LT.ensureBunny === "function")
                LT.ensureBunny();
        },
        getContent: function () {
    ...
    LT.defineNode({
        ...
        chrome: { left: true, right: true },
        applyPreParsingEffects: function () {
            if (typeof LT.ensureLoppy === "function")
                LT.ensureLoppy();
        },
        getContent: function () {
    ...
    LT.defineNode({
        ...
        getContent: function () {
            var html;
            if (!hasLicense())
                html = xml("BEDROOM_EMPTY");
            else if (!firstFloor())
                html = xml("BEDROOM_EMPTY_WHORE_SELF_GROUND_FLOOR");
            else
                html = xml("BEDROOM_EMPTY_WHORE_SELF");
...
//# sourceMappingURL=angelsKiss.js.map