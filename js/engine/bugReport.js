...
(function () {
    ...
    window.addEventListener("error", function (e) {
        pushBounded(LT.bugReportErrors, {
            time: nowIso(),
            message: e.message,
            source: e.filename,
            line: e.lineno,
    ...
    document.addEventListener("lt-content", function (e) {
        var detail = e.detail;
        var node = detail && detail.node;
        if (!node)
            return;
        pushBounded(LT.bugReportHistory, {
            time: nowIso(),
            type: "node",
            label: String(node.id || "?"),
        });
    });
    document.addEventListener("lt-choice", function (e) {
        var detail = e.detail;
    ...
    LT.buildBugReport = function () {
        ...
        var snap = null;
        try {
            if (typeof LT.snapshotGame === "function")
                snap = LT.snapshotGame();
        }
        catch (err) {
