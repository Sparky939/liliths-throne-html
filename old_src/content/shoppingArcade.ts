  ...
  LT.defineNode({
    ...
    getContent: function () {
      return LT.itemShopHtml(
        "ralph",
        "<p>The interior of Ralph's Snacks is packed with bottles, boxes, and labelled drinks. Ralph grins from behind the counter and waits for you to pick something.</p>",
      );
    },
    getResponses: function () {
